...
function VoiceSynthesizer({
  ...
  // synth is responsible for the talking part
  ...
  useEffect(() => {
    ...
    // SpeechSynthesisUtterance is an API that allow us to represent speech request.  It contains the content the speech service should read and information about how to read
